...
// These 4 templates make use of a trick called 'trailing return types' to avoid writing and
// duplicating long type names, by setting its signature's return type to 'auto', and only writing
// it's actual return type at the end;
template <class Stoppoint>
